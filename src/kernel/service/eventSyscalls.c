...
void handleCreateEventSyscall(Thread *call) {
...
void handleGetEventSyscall(Thread *call) {
...
void handleFireEventSyscall(Thread *call) {
    Service *service = call->service;
...
void handleSubscribeEventSyscall(Thread *call) {
...
void handleAwaitSyscall(Thread *call) {
